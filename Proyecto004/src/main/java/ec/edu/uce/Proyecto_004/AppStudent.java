...
public class AppStudent extends JFrame implements ActionListener{
	   ...
	   private SessionFactory sessionFactory;
		...
		public void actionPerformed(ActionEvent e) {
	    	DAOStudent studentCRUD = new DAOStudent(sessionFactory);
			// TODO Auto-generated method stub
			if (e.getSource() == createButton) {
				studentCRUD.createStudent();   
	        } else if (e.getSource() == readButton) {
	        	studentCRUD.searchStudent();
	        } else if (e.getSource() == updateButton) {
	        	studentCRUD.updateStudent();
	        } else if (e.getSource() == deleteButton) {
	        	studentCRUD.eraseStudent();          
