...
public class AppSubject extends JFrame implements ActionListener{
	   ...
	   private SessionFactory sessionFactory;
		...
		public void actionPerformed(ActionEvent e) {
	    	DAOSubject subjectCRUD = new DAOSubject(sessionFactory);
			// TODO Auto-generated method stub
			if (e.getSource() == createButton) {
				subjectCRUD.createSubject();   
	        } else if (e.getSource() == readButton) {
	        	subjectCRUD.searchSubject();
	        } else if (e.getSource() == updateButton) {
	        	subjectCRUD.updateSubject();
	        } else if (e.getSource() == deleteButton) {
	        	subjectCRUD.eraseSubject();         
